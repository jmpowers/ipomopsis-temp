---
title: "Ipomopsis temperature experiments"
...
meta %>% count(Year, Temp, Tissue, PlantType, OI, DN, Expt)
```
...
vol.otc <- vol[svf.otc$sample,]
(cap.otc.comb <- capscale(sqrt(vol.otc) ~ Year+Site+OI+mean_temp_C_treatment, distance="bray", data=svf.otc))
...
## Heatmap
```{r heatmap_leaf, fig.height=8, fig.width=12}
