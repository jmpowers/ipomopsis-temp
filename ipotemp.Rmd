...
## OTC soil moisture
```{r soil}
ggplot(meta %>% filter(Expt=="otc", temp !="air", Site != "bb"), aes(x=paste(Year, Site, Date), y=SoilVWC, color=temp)) +
...
samplesperplant %>% ggplot(aes(x=n)) + facet_grid(Site ~ Year) + geom_histogram(binwidth=1)
